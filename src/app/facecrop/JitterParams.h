#ifndef __facecrop_JitterParams_h__
#define __facecrop_JitterParams_h__
...
struct JitterParams
{
    ...
    cv::Matx33f operator()(cv::RNG &rng, const cv::Size &size) const;
...
#endif // __facecrop_JitterParams_h__
