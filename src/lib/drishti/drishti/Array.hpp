...
public:
    ...
    public:
        ...
        iterator operator++(int) { iterator i = *this; ptr_++; return i; } // optional
        iterator& operator+=(size_type n) { ptr_+= n; return *this; } //optional
        iterator operator+(size_type n) const { iterator i = *this; i += n; return i; } //optional
    ...
    public:
        ...
        const_iterator& operator=(const const_iterator&other) { ptr_ = other.ptr_; return *this; }
        ...
        const_iterator operator++(int) { iterator i = *this; ptr_++; return i; } // optional
        
        const_iterator& operator+=(size_type n) { ptr_+= n; return *this; } //optional
        const_iterator operator+(size_type n) const { iterator i = *this; i += n; return i; } //optional
    ...
    Array() : size_(0) {}
    Array(std::size_t size) : size_(std::min(size,N)) {} // clippinpg semantics
